...
class Test(unittest.TestCase):
    ...
    def test_dbg_file(self):
        self.assertTrue(self.dra.dbg_file.endswith(self.tc.debugger_extension))
        self.assertTrue(self.dra.dbg_file.startswith(self.tc.fuzzedfile.path))
