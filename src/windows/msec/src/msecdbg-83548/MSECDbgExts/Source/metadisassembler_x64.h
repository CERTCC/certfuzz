//
// metadisassembler_x64.h
//
// Definitions for the MSEC Debugging Extensions Meta-Disassembler for x64 Processors
//
//
...
PCWSTR X64_MNEMONIC_PREFIXES[] = { L"rep", L"repe", L"repz", L"repne", L"repnz", NULL };

///
// x64 Processor Register Sets
///
PCWSTR X64_REGISTERS[] = {	L"ah", L"al", L"ax", L"eax", L"rax",
							L"bh", L"bl", L"bx", L"ebx", L"rbx",
							L"ch", L"cl", L"cx", L"ecx", L"rcx",
							L"dh", L"dl", L"dx", L"edx", L"rdx",
...
///
// x64 Processor Register Aliases
///
//
// Important note:
//		With the x86/x64 registers, we have incomplete aliasing. Because of this, we actually implement two sets of aliases, one for applying
...
OPERAND X64_REGISTER_TAINT_ALIASES[] =  {
											OPERAND_ENTRY(L"al"), OPERAND_ENTRY(L"ax"), OPERAND_ENTRY(L"eax"), OPERAND_ENTRY(L"rax"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ah"), OPERAND_ENTRY(L"ax"), OPERAND_ENTRY(L"eax"), OPERAND_ENTRY(L"rax"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ax"), OPERAND_ENTRY(L"ah"), OPERAND_ENTRY(L"al"), OPERAND_ENTRY(L"eax"), OPERAND_ENTRY(L"rax"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"eax"), OPERAND_ENTRY(L"ah"), OPERAND_ENTRY(L"ax"), OPERAND_ENTRY(L"al"), OPERAND_ENTRY(L"rax"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rax"), OPERAND_ENTRY(L"ah"), OPERAND_ENTRY(L"ax"), OPERAND_ENTRY(L"al"), OPERAND_ENTRY(L"eax"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"bl"), OPERAND_ENTRY(L"bx"), OPERAND_ENTRY(L"ebx"), OPERAND_ENTRY(L"rbx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"bh"), OPERAND_ENTRY(L"bx"), OPERAND_ENTRY(L"ebx"), OPERAND_ENTRY(L"rbx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"bx"), OPERAND_ENTRY(L"bh"), OPERAND_ENTRY(L"bl"), OPERAND_ENTRY(L"ebx"), OPERAND_ENTRY(L"rbx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ebx"), OPERAND_ENTRY(L"bh"), OPERAND_ENTRY(L"bx"), OPERAND_ENTRY(L"bl"), OPERAND_ENTRY(L"rbx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rbx"), OPERAND_ENTRY(L"bh"), OPERAND_ENTRY(L"bx"), OPERAND_ENTRY(L"bl"), OPERAND_ENTRY(L"ebx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"cl"), OPERAND_ENTRY(L"cx"), OPERAND_ENTRY(L"ecx"), OPERAND_ENTRY(L"rcx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ch"), OPERAND_ENTRY(L"cx"), OPERAND_ENTRY(L"ecx"), OPERAND_ENTRY(L"rcx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"cx"), OPERAND_ENTRY(L"ch"), OPERAND_ENTRY(L"cl"), OPERAND_ENTRY(L"ecx"), OPERAND_ENTRY(L"rcx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ecx"), OPERAND_ENTRY(L"ch"), OPERAND_ENTRY(L"cx"), OPERAND_ENTRY(L"cl"), OPERAND_ENTRY(L"rcx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rcx"), OPERAND_ENTRY(L"ch"), OPERAND_ENTRY(L"cx"), OPERAND_ENTRY(L"cl"), OPERAND_ENTRY(L"ecx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"dl"), OPERAND_ENTRY(L"dx"), OPERAND_ENTRY(L"edx"), OPERAND_ENTRY(L"rdx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"dh"), OPERAND_ENTRY(L"dx"), OPERAND_ENTRY(L"edx"), OPERAND_ENTRY(L"rdx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"dx"), OPERAND_ENTRY(L"dh"), OPERAND_ENTRY(L"dl"), OPERAND_ENTRY(L"edx"), OPERAND_ENTRY(L"rdx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"edx"), OPERAND_ENTRY(L"dh"), OPERAND_ENTRY(L"dx"), OPERAND_ENTRY(L"dl"), OPERAND_ENTRY(L"rdx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rdx"), OPERAND_ENTRY(L"dh"), OPERAND_ENTRY(L"dx"), OPERAND_ENTRY(L"dl"), OPERAND_ENTRY(L"edx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"si"), OPERAND_ENTRY(L"esi"), OPERAND_ENTRY(L"rsi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"esi"), OPERAND_ENTRY(L"si"), OPERAND_ENTRY(L"rsi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rsi"), OPERAND_ENTRY(L"si"), OPERAND_ENTRY(L"esi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"di"), OPERAND_ENTRY(L"edi"), OPERAND_ENTRY(L"rdi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"edi"), OPERAND_ENTRY(L"di"), OPERAND_ENTRY(L"rdi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rdi"), OPERAND_ENTRY(L"di"), OPERAND_ENTRY(L"edi"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"sp"), OPERAND_ENTRY(L"esp"), OPERAND_ENTRY(L"rsp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"esp"), OPERAND_ENTRY(L"sp"), OPERAND_ENTRY(L"rsp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rsp"), OPERAND_ENTRY(L"sp"), OPERAND_ENTRY(L"esp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"bp"), OPERAND_ENTRY(L"ebp"), OPERAND_ENTRY(L"rbp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ebp"), OPERAND_ENTRY(L"bp"), OPERAND_ENTRY(L"rbp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rbp"), OPERAND_ENTRY(L"bp"), OPERAND_ENTRY(L"ebp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ip"), OPERAND_ENTRY(L"eip"), OPERAND_ENTRY(L"rip"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"eip"), OPERAND_ENTRY(L"ip"), OPERAND_ENTRY(L"rip"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rip"), OPERAND_ENTRY(L"ip"), OPERAND_ENTRY(L"eip"), END_OPERAND_LIST,
...
OPERAND X64_REGISTER_CLEAR_ALIASES[] =  {
											...
											OPERAND_ENTRY(L"rax"), OPERAND_ENTRY(L"eax"), OPERAND_ENTRY(L"al"), OPERAND_ENTRY(L"ah"), OPERAND_ENTRY(L"ax"), END_OPERAND_LIST,
											...
											OPERAND_ENTRY(L"rbx"), OPERAND_ENTRY(L"ebx"), OPERAND_ENTRY(L"bl"), OPERAND_ENTRY(L"bh"), OPERAND_ENTRY(L"bx"), END_OPERAND_LIST,
											...
											OPERAND_ENTRY(L"rcx"), OPERAND_ENTRY(L"ecx"), OPERAND_ENTRY(L"cl"), OPERAND_ENTRY(L"ch"), OPERAND_ENTRY(L"cx"), END_OPERAND_LIST,
											...
											OPERAND_ENTRY(L"rdx"), OPERAND_ENTRY(L"edx"), OPERAND_ENTRY(L"dl"), OPERAND_ENTRY(L"dh"), OPERAND_ENTRY(L"dx"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"esi"), OPERAND_ENTRY(L"si"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rsi"), OPERAND_ENTRY(L"esi"), OPERAND_ENTRY(L"si"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"edi"), OPERAND_ENTRY(L"di"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rdi"), OPERAND_ENTRY(L"edi"), OPERAND_ENTRY(L"di"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"esp"), OPERAND_ENTRY(L"sp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rsp"), OPERAND_ENTRY(L"esp"), OPERAND_ENTRY(L"sp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"ebp"), OPERAND_ENTRY(L"bp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rbp"), OPERAND_ENTRY(L"ebp"), OPERAND_ENTRY(L"bp"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"eip"), OPERAND_ENTRY(L"ip"), END_OPERAND_LIST,
											OPERAND_ENTRY(L"rip"), OPERAND_ENTRY(L"eip"), OPERAND_ENTRY(L"ip"), END_OPERAND_LIST,
...
INSTRUCTION_INFO X64_DISASSEMBLY_INFO[] =
{
	// Add with Carry
	...
	BEGIN_INSTRUCTION
		...
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		IMPLICIT_PASSED_OR_RETURNED_REGISTERS OPERAND_ENTRY(STACK_CONTENTS), OPERAND_ENTRY(L"rcx"), OPERAND_ENTRY(L"rdx"), OPERAND_ENTRY(L"r8"), OPERAND_ENTRY(L"r9"), END_OPERAND_LIST
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rsi" ), OPERAND_ENTRY( L"rdi" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( L"rsi" ), OPERAND_ENTRY( L"rdi" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( L"rsi" ), OPERAND_ENTRY( L"rdi" ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rax" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( L"rax" ), OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( L"rax" ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING SOURCE_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_REGISTERS
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_REGISTERS
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING COMBO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( L"rsi" ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_REGISTERS
		IMPLICIT_DESTINATION_POINTER_REGISTERS OPERAND_ENTRY( L"rdi" ), END_OPERAND_LIST
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING COMBO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( L"rsi" ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( L"rcx" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_POINTER_REGISTERS OPERAND_ENTRY( L"rdi" ), END_OPERAND_LIST
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rax" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( L"rax" ), OPERAND_ENTRY( L"rdx" ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( STACK_CONTENTS ),OPERAND_ENTRY( L"rsp" ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_REGISTERS
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING DEST_REGISTER
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rsp" ), END_OPERAND_LIST
	...
	BEGIN_INSTRUCTION
		...
		NO_IMPLICIT_SOURCE_REGISTERS
		NO_IMPLICIT_DESTINATION_REGISTERS
		IMPLICIT_DESTINATION_POINTER_REGISTERS OPERAND_ENTRY( L"rsp" ), END_OPERAND_LIST
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		NO_IMPLICIT_DESTINATION_REGISTERS
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		IMPLICIT_PASSED_OR_RETURNED_REGISTERS OPERAND_ENTRY( L"rax" ), END_OPERAND_LIST
	END_INSTRUCTION

	// Scan String
	//
	// Note that the SCAS instruction will treat all of RAX as a source, even though which part of RAX
	// is used depends on whether we are in byte, word, doubleword, or quadword mode. However, the meta-disassembler removes
	// that information from the source, so we have to assume RAX
	BEGIN_INSTRUCTION
		MNEMONIC( L"scas" )
		INSTRUCTION_CLASSIFICATION CALCULATION
		OPERAND_ENCODING NO_OPERANDS
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rax" ), OPERAND_ENTRY( L"rdi" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS 
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rax" ), OPERAND_ENTRY( L"rcx" ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
	...
	BEGIN_INSTRUCTION
		...
		OPERAND_ENCODING NO_OPERANDS 
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"rax" ), OPERAND_ENTRY( L"rcx" ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		IMPLICIT_DESTINATION_REGISTERS OPERAND_ENTRY( AUX_FLAG ), OPERAND_ENTRY( CARRY_FLAG ), OPERAND_ENTRY( OVERFLOW_FLAG ), OPERAND_ENTRY( SIGN_FLAG ), OPERAND_ENTRY( PARITY_FLAG ), OPERAND_ENTRY( ZERO_FLAG ), END_OPERAND_LIST
		NO_IMPLICIT_DESTINATION_POINTER_REGISTERS
		NO_IMPLICIT_PASSED_OR_RETURNED_REGISTERS
	END_INSTRUCTION
    ...
    BEGIN_INSTRUCTION
		...
		NO_ANALYSIS_FUNCTIONS
		IMPLICIT_SOURCE_REGISTERS OPERAND_ENTRY( L"al" ), OPERAND_ENTRY( L"rbx" ), END_OPERAND_LIST
